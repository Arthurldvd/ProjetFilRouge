...
// Formulaire complet avec ajout de questions et réponses

import { ref, computed } from 'vue'
import { useRouter } from 'vue-router'
import { createQuiz, generateQuestionsWithAI } from '../services/quizService'
...
async function handleSubmit() {
  ...
  try {
    ...
    error.value = e instanceof Error ? e.message : 'Erreur lors de la création du quiz'
  } finally {
      ...
      <form @submit.prevent="handleSubmit" class="quiz-form">
        ...
        <div class="form-actions">
          ...
          >
            ...
            <span v-else>Créer le quiz</span>
          </button>
        </div>
      </form>
    </div>
